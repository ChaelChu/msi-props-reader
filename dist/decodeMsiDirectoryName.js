...
exports.decodeMsiDirectoryName = void 0;
...
function decodeMsiDirectoryName(name) {
    var ch = name.charCodeAt(0);
    var idx = 0;
    var out = [];
    if (ch == 0x4840)
        ++idx; // TODO: is this actually supposed to be a null byte?
...
exports.decodeMsiDirectoryName = decodeMsiDirectoryName;
